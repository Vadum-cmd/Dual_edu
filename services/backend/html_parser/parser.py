...
# Make request 
html=requests.get("https://www.englishprofile.org/wordlists/evp?filter_search=&filter_custom_Level%5B%5D=1&filter_custom_Level%5B%5D=2&filter_custom_Level%5B%5D=3&filter_custom_Level%5B%5D=4&filter_custom_Level%5B%5D=5&filter_custom_Level%5B%5D=6&filter_custom_Topic=&filter_custom_Parts=8&filter_custom_Category=&filter_custom_Grammar=&filter_custom_Usage=&filter_custom_Prefix=&filter_custom_Suffix=&limit=0&directionTable=asc&sortTable=base&task=&boxchecked=0&filter_order=pos_rank&filter_order_Dir=asc&1c6d6089aeb4be20d9781e819b825da7=1")
# # Parsing the HTML
